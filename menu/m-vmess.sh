...
permission_file=$(curl -s --connect-timeout 10 https://raw.githubusercontent.com/mylo1998/ijin/refs/heads/main/Mylo)
...
xhttp1="vmess://$(echo "$x1" | base64 -w 0)"
xhttp2="vmess://$(echo "$x2" | base64 -w 0)"
VMESS_WS=`cat<<EOF
{
"v": "2",
"ps": "${user}",
...
Link Vmess Account
_______________________________________________________
Link WS TLS: vmess://$(echo $VMESS_WS | base64 -w 0)
_______________________________________________________
Link WS NTLS: vmess://$(echo $VMESS_NON_TLS | base64 -w 0)
_______________________________________________________
Link XHTTP TLS: vmess://$(echo $xhttp1 | base64 -w 0)
_______________________________________________________
Link XHTTP NTLS: vmess://$(echo $xhttp2 | base64 -w 0)
_______________________________________________________
...
Security     : auto
Network      : WS or XHTTP
Path         : <code>/vmessws</code>
Path Support : <code>https://bug.com/vmessws</code>
XHTTP        : <code>/xvmess</code>
◇━━━━━━━━━━━━━━━━━◇
Link TLS     :
...
echo -e "$COLOR1 ${NC} ${WH}Port XHTTP   ${COLOR1}: ${WH}443 & 80" | tee -a /etc/vmess/akun/log-create-${user}.log
...
echo -e "$COLOR1 ${NC} ${WH}Path          ${COLOR1}: ${WH}/vmessws" | tee -a /etc/vmess/akun/log-create-${user}.log
echo -e "$COLOR1 ${NC} ${WH}Path Support  ${COLOR1}: ${WH}http://bug/vmessws" | tee -a /etc/vmess/akun/log-create-${user}.log
echo -e "$COLOR1 ${NC} ${WH}XHTTP Path    ${COLOR1}: ${WH}/xvmess" | tee -a /etc/vmess/akun/log-create-${user}.log
echo -e "$COLOR1 ◇━━━━━━━━━━━━━━━━━◇ ${NC}" | tee -a /etc/vmess/akun/log-create-${user}.log
...
echo -e "$COLOR1 ◇━━━━━━━━━━━━━━━━━◇ ${NC}" | tee -a /etc/vmess/akun/log-create-${user}.log
echo -e "$COLOR1 ${NC} ${COLOR1}Link XHTTP TLS${WH}: ${NC}" | tee -a /etc/vmess/akun/log-create-${user}.log
echo -e "$COLOR1${NC}${WH}${xhttp1}${NC}"  | tee -a /etc/vmess/akun/log-create-${user}.log
echo -e "$COLOR1 ◇━━━━━━━━━━━━━━━━━◇ ${NC}" | tee -a /etc/vmess/akun/log-create-${user}.log
echo -e "$COLOR1 ${NC} ${COLOR1}Link XHTTP NTLS${WH}: ${NC}" | tee -a /etc/vmess/akun/log-create-${user}.log
echo -e "$COLOR1${NC}${WH}${xhttp2}${NC}"  | tee -a /etc/vmess/akun/log-create-${user}.log
echo -e "$COLOR1 ◇━━━━━━━━━━━━━━━━━◇ ${NC}" | tee -a /etc/vmess/akun/log-create-${user}.log
...
_______________________________________________________
Link XHTTP TLS : vmess://$(echo "$x1" | base64 -w 0)
_______________________________________________________
Link XHTTP NTLS : vmess://$(echo "$x2" | base64 -w 0)
_______________________________________________________
Link Opok : vmess://$(echo $VMESS_OPOK | base64 -w 0)
_______________________________________________________
END

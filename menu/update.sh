...
wget -q -O /usr/bin/m-vless "https://raw.githubusercontent.com/mylo1998/Mylo/refs/heads/main/menu/m-vless.sh" && chmod +x /usr/bin/m-vless
wget -q -O /usr/bin/m-trojan "https://raw.githubusercontent.com/mylo1998/Mylo/refs/heads/main/menu/m-trojan.sh" && chmod +x /usr/bin/m-trojan

wget -q -O /usr/bin/system "https://raw.githubusercontent.com/mylo1998/Mylo/refs/heads/main/menu/system.sh" && chmod +x /usr/bin/system
wget -q -O /usr/bin/sshws "https://raw.githubusercontent.com/mylo1998/Mylo/refs/heads/main/menu/sshws.sh" && chmod +x /usr/bin/sshws
wget -q -O /usr/bin/running "https://raw.githubusercontent.com/mylo1998/Mylo/refs/heads/main/menu/running.sh" && chmod +x /usr/bin/running
wget -q -O /usr/bin/cekservice "https://raw.githubusercontent.com/mylo1998/Mylo/refs/heads/main/menu/cekservice.sh" && chmod +x /usr/bin/cekservice
wget -q -O /usr/bin/m-update "https://raw.githubusercontent.com/mylo1998/Mylo/refs/heads/main/menu/m-update.sh" && chmod +x /usr/bin/m-update
...
wget -q -O /usr/bin/manual-restore "https://raw.githubusercontent.com/mylo1998/Mylo/refs/heads/main/menu/manual-restore.sh" && chmod +x /usr/bin/manual-restore
